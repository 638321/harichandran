...
export const CheckoutModal: React.FC = () => {
  const { isCheckoutOpen, setIsCheckoutOpen, cartTotal, clearCart } = useAppContext();
                  ...
                  <form id="checkout-form" onSubmit={handleCheckout} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <input 
                            type="text" 
                            defaultValue="Harish Raghav"
                            readOnly
                            className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl py-3 pl-12 pr-4 text-slate-900 dark:text-white focus:outline-none" 
                          />
                        </div>
                      </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <textarea 
                          defaultValue="123, Tech Park, Innovation City&#10;Phase 1, Electronic Sector&#10;Chennai - 600001, Tamil Nadu"
                          readOnly
                          rows={3}
                          className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl py-3 pl-12 pr-4 text-slate-900 dark:text-white focus:outline-none resize-none leading-relaxed" 
                        />
                      </div>
                    </div>
                    ...
                    <div className="p-5 rounded-2xl bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/30">
                      ...
                      <div className="flex gap-4">
                        <input 
                          ...
                          defaultValue="1234"
                          readOnly
                          className="w-full max-w-[150px] bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl py-3 px-4 text-center text-xl font-bold tracking-widest text-slate-900 dark:text-white focus:outline-none" 
                        />
