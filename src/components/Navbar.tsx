...
export const Navbar: React.FC = () => {
  const { cartCount, setIsCartOpen, setIsSearchOpen, setIsProfileOpen, setAuthModalType, isDarkMode, toggleDarkMode } = useAppContext();
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          >
            <img src="/images/logo.png" alt="HariChandra Logo" className="w-10 h-10 object-contain rounded-xl" />
